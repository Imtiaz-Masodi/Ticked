...
export const NAV_ITEMS: readonly NavigationItem[] = Object.freeze([
  ...
  { name: "All Tasks", path: "/tasks/all", icon: Icons.task },
  { name: "Backlogs", path: "/tasks/backlog", icon: Icons.archive },
  { name: "Completed", path: "/tasks/completed", icon: Icons.taskDone },
