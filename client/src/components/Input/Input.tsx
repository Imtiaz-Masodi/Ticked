...
const Input = ({
  ...
  return (
    <div className="flex-grow">
      ...
      <div
        className={`
          flex items-center border border-slate-200 dark:border-gray-600 rounded-lg px-3 py-2.5 w-full
      ...
      >
        <input
          name={name}
          value={value}
          className={`w-full bg-transparent text-slate-700 dark:text-gray-200 text-sm focus-visible:outline-none disabled:cursor-not-allowed dark:[color-scheme:dark] [color-scheme:light] placeholder:text-slate-400 dark:placeholder:text-gray-500 ${className}`}
