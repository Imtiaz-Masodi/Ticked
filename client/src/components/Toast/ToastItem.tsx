...
const ToastItem: React.FC<ToastItemProps> = ({ toast, onDismiss }) => {
  ...
  return (
    <div
      className={`
        relative max-w-sm md:min-w-80 w-full border rounded-lg shadow-lg p-4 mb-3
    ...
    >
      ...
      <div className="flex items-start">
        {/* Icon */}
        <div className={`flex-shrink-0 ${styles.icon} mt-px`}>
          <Icon name={styles.iconName} />
        </div>

        {/* Content */}
        <div className="ml-3 flex-1">
          {toast.title && <h4 className="font-medium text-sm mb-1 select-none">{toast.title}</h4>}
